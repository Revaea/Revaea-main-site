                ...
                >
                  ...
                  >
                    <Image
                      ...
                      className="revaea-breathe-target object-contain select-none [-webkit-user-drag:none] transform-gpu origin-center transition-[filter] duration-300 dark:brightness-80"
                      draggable={false}
                      priority
                    />
                  </HoverCircleMask>
