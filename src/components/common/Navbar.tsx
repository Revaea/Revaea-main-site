        ...
        <div className="pt-[env(safe-area-inset-top)]">
          <div
            ...
            className={
              ...
              (isAtTop
                ? "border border-x-transparent border-t-transparent border-b border-b-[color:color-mix(in_oklab,var(--color-brand)_30%,transparent)] dark:border-b-[color:color-mix(in_oklab,var(--color-brand)_40%,transparent)] shadow-[0_12px_28px_color-mix(in_oklab,var(--color-brand)_12%,transparent)]"
